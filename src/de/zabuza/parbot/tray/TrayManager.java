...
import de.zabuza.parbot.exceptions.UnsupportedSystemTrayException;
import de.zabuza.parbot.logging.ILogger;
import de.zabuza.parbot.logging.LoggerFactory;
import de.zabuza.parbot.tray.listener.ExitListener;
import de.zabuza.parbot.tray.listener.RestartListener;
...
public final class TrayManager {
	 ...
	 */
	private static final String NAME_TRAY = "Parbot";
	/**
	 ...
	 *            The image of the tray icon which is managed by this object
	 */
	public TrayManager(final Parbot parent, final Image trayIconImage) {
		this.mParent = parent;
